...
function setup() {
  ...
  x1speed = sin(random(0, TWO_PI)) * random(100);
  y1speed = cos(random(0, TWO_PI)) * random(100);

  x2speed = sin(random(0, TWO_PI)) * random(100);
  y2speed = cos(random(0, TWO_PI)) * random(100);
}
